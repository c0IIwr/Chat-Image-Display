...
> Просто отправь в чат ссылку с поддерживаемым форматом файла (Пример: .jpg, .gif, .mp4, .mp3), или перетащи изображение со своего компьютера в окно ввода
...
Как отправить картинку или гифку со своего компьютера?

> Перетащи файл изображения в окно ввода чата
